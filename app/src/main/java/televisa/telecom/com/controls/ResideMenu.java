...
import telecom.televisa.com.izzi.BtfLanding;
import telecom.televisa.com.izzi.IzziMovilApplication;
import telecom.televisa.com.izzi.MainActivity;
...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
           ...
           cerrarSession= scrollViewLeftMenu.findViewById(R.id.cerrarSession);
            profile=scrollViewLeftMenu.findViewById(R.id.profile);
        }
    ...
    public View getCerrarSession() {
        return cerrarSession;
    }

    public void setCerrarSession(View cerrarSession) {
